...
struct Round {
    ...
    func storeRandomNumber(numberToStore: Int) {
        if randomNumberStorage.contains(numberToStore) == false {
            randomNumberStorage.append(numberToStore)
        }
    }
    
    func setUpQuestionsForRound() {
        while randomNumberStorage.count < 5 {
            storeRandomNumber(randomNumber())
        }
    }
    
    func prepareNextRound() {
        randomNumberStorage.removeAll()
        setUpQuestionsForRound()
    }
    
    func chooseAnswer(selectedRow: Int, numberFromStorageArray: Int) {
        print(questions[randomNumberStorage[numberFromStorageArray]].question)
        let userAnswer = questions[randomNumberStorage[numberFromStorageArray]].possibleAnswers[selectedRow]
        print("I pick \(userAnswer).")
        if userAnswer == questions[randomNumberStorage[numberFromStorageArray]].correctAnswer {
            print("You chose the correct answer: \(userAnswer)")
        } else {
            print("You're wrong.  The answer is \(questions[randomNumberStorage[numberFromStorageArray]].correctAnswer)")
        }
    }
}
...
var roundOneQuestionTwo = Question(question: "The Civil War started in what year?", possibleAnswers: ["1865", "1861", "1859", "1869"], correctAnswer: "1861")
...
var roundOneQuestionTen = Question(question: "What is special about the sentence “The Quick Brown Fox Jumps Over The Lazy Dog?”", possibleAnswers: ["It was a secret military operation during WWII", "It has all letters of the alphabet", "All capitalized letters spell out a famous city in the United States", "Famous line from Robert Frost poem"], correctAnswer: "It has all letters of the alphabet")
...
var rountTwoQuestionTen = Question(question: "Bob Dylan real name is:", possibleAnswers: ["Robert Zimmerman", "Robin Zachary", "Richard Roberts", "James Johnson"], correctAnswer: "Robert Zimmerman")
...
var roundThreeQuestionNine = Question(question: "What was the name of the NBA basketball player who was taken directly before Michael Jordan in the 1984 NBA Draft?", possibleAnswers: ["Hakeem Olajuwon", "Sam Perkins", "Alvin Robertson", "Sam Bowie"], correctAnswer: "Sam Bowie")
var roundThreeQuestionTen = Question(question: "Pteronophobia is the fear of:", possibleAnswers: ["Being tickled by feathers",
    "Being attacked by dinosaurs", "Being assaulted by police officers", "Being touched by other humans"], correctAnswer: "Being tickled by feathers")


var roundOne = Round(name: "Round One", questions: [roundOneQuestionOne, roundOneQuestionTwo, roundOneQuestionThree, roundOneQuestionFour, roundOneQuestionFive, roundOneQuestionSix, roundOneQuestionSeven, roundOneQuestionEight, roundOneQuestionNine, roundOneQuestionTen])
var roundTwo = Round(name: "Round Two", questions: [roundTwoQuestionOne, roundTwoQuestionTwo, roundTwoQuestionThree, roundTwoQuestionFour, roundTwoQuestionFive, roundTwoQuestionSix, roundTwoQuestionSeven, roundTwoQuestionEight, roundTwoQuestionNine, rountTwoQuestionTen])
var roundThree = Round(name: "Round Three", questions: [roundThreeQuestionOne, roundThreeQuestionTwo, roundThreeQuestionThree, roundThreeQuestionFour, roundThreeQuestionFive, roundThreeQuestionSix, roundThreeQuestionSeven, roundThreeQuestionEight, roundThreeQuestionNine, roundThreeQuestionTen])
